...
from fastapi_mvc_example.cli.commands.serve import (
    serve,
    validate_directory,
)
...
def test_validate_directory():
    ...
    with mock.patch("fastapi_mvc_example.cli.commands.serve.os.access") as mck:
...
@mock.patch("fastapi_mvc_example.cli.commands.serve.run_wsgi")
